...
import {{package_name}}.model.Usuario;
import {{package_name}}.support.enums.ApiBaseUri;
import {{package_name}}.support.enums.ApiPath;

import java.io.IOException;
import java.nio.file.Files;
import java.nio.file.Paths;

import static {{package_name}}.support.utils.RestContext.*;
